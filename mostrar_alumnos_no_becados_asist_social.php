		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="container-fluid">
					 ...
					 <form action="mostrar_alumno_no_becado_buscar_asist_social.php" method="post">
  ...
  <table class="table">
    <thead>
        ...
        require 'conexion_i.php';
         $query = "SELECT a.* FROM alumno a join beca b on a.id_alumno=b.id_alumno WHERE estado_beca=0";
