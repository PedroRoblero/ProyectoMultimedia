...
<body>
    ...
    <thead>
        ...
        <?php
          ...
          $query="SELECT * FROM casino WHERE tipo_casino='$CARGO'";
    ...
    ?> 
      <tr>
        ...
        <td><a href="modificar_casino_casino.php?id=<?php echo $fila['id_casino'] ?>" class="btn btn-warning btn-xs"> Modificar Funcionario</td>
