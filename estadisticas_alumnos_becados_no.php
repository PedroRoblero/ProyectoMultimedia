<?php 
    ...
    $query="SELECT * from beca where estado_beca=1";
    $result=$mysqli->query($query);

    $query2="SELECT * from beca where estado_beca=0";
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Alumnos becados y no becados'
        },
        tooltip: {
        ...
        series: [{
            ...
            name: 'porcentaje',
            data: [
                ['Becados',   <?php echo $data;  ?>],
                ['No Becados',       <?php echo $data2; ?>],
            ]
        }]
    });
});
