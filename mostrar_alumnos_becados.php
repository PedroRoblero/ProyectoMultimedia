        ...
        <ul class="user-menu">
          <li class="dropdown pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="cambiar_contraseña_admin_dae.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Cambiar Contraseña</a>
      ...
      <div class="col-md-8">
          ...
          <div class="container-fluid">
           ...
           <form action="mostrar_alumno_becado_buscar_dae.php" method="post">
            ...
            <form action="mostrar_alumno_estado_dae.php" method="post">
            ...
            <form action="mostrar_alumno_becado_carrera_dae.php" method="post">
