...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		$query = "SELECT * FROM dae WHERE id_dae='$id'";
		$result=$mysqli->query($query);
		$row=$result->fetch_assoc();
	 ?>
	
	<form action="modificar_dae_final.php?id=<?php echo $row['id_dae']; ?>" method="POST">
		<br><br>
		<input type="text" REQUIERED name="nombre" placeholder="Nombre" value="<?php echo $row['nombre']; ?>" /><br/><br/>
		<input type="text" REQUIERED name="apellido_pat" placeholder="Apellido Pat" value="<?php echo $row['apellido_pat']; ?>" /><br/><br/>
		<input type="text" REQUIERED name="apellido_mat" placeholder="Apellido Mat" value="<?php echo $row['apellido_mat']; ?>" /><br/><br/>
							Cargo: <br>
							 	<input type="radio" name="tipo_dae" value="admin_dae" checked> Admin DAE <br>
  								<input type="radio" name="tipo_dae" value="secre"> Secretario/a<br>
  								<input type="radio" name="tipo_dae" value="asist_social"> Asistente Social <br> <br>

		
		<input type="text" REQUIERED name="correo" placeholder="Correo" value="<?php echo $row['correo']; ?>" /><br/><br/>
