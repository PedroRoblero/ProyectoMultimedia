<?php 
	...
	$query="SELECT * from uso_beca where fecha BETWEEN '2017-03-01' AND '2017-03-31'";
	$result=$mysqli->query($query);

	$query2="SELECT * from uso_beca where fecha BETWEEN '2017-04-01' AND '2017-04-30'";
	$result2=$mysqli->query($query2);

	$query3="SELECT * from uso_beca where fecha BETWEEN '2017-05-01' AND '2017-05-31'";
	$result3=$mysqli->query($query3);

	$query4="SELECT * from uso_beca where fecha BETWEEN '2017-06-01' AND '2017-06-30'";
	$result4=$mysqli->query($query4);

	$query5="SELECT * from uso_beca where fecha BETWEEN '2017-07-01' AND '2017-07-31'";
	$result5=$mysqli->query($query5);

	$query6="SELECT * from uso_beca where fecha BETWEEN '2017-08-01' AND '2017-08-31'";
	$result6=$mysqli->query($query6);

	$query7="SELECT * from uso_beca where fecha BETWEEN '2017-09-01' AND '2017-09-30'";
	$result7=$mysqli->query($query7);

	$query8="SELECT * from uso_beca where fecha BETWEEN '2017-10-01' AND '2017-10-31'";
	$result8=$mysqli->query($query8);

	$query9="SELECT * from uso_beca where fecha BETWEEN '2017-11-01' AND '2017-11-30'";
	$result9=$mysqli->query($query9);

	$query10="SELECT * from uso_beca where fecha BETWEEN '2017-12-01' AND '2017-12-31'";
	...
	$data8=$result8->num_rows;
	$data9=$result9->num_rows;
	$data10=$result10->num_rows;
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Estadistica casino del año actual'
        },
        subtitle: {
...
<div id="container" style="min-width: 810px; max-width: 1200px; height: 500px; margin: 8 auto"></div>
