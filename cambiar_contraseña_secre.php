...
require 'conexion_i.php';
  ...
  if(isset($_SESSION['usuario'])){
    ...
    if($_SESSION['usuario']['tipo_usuario'] != "secre"){
...
<body>
        ...
        <ul class="user-menu">
          <li class="dropdown pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><a href="cambiar_contraseña_secre.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Cambiar Contraseña</a></li> 
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li><a href="mostrar_alumnos_becados_secre.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Mostrar Alumnos Becados</a></li>
      <li><a href="mostrar_alumnos_no_becados_secre.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Mostrar Alumnos No Becados</a></li>
