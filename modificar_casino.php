...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		$query = "SELECT * FROM casino WHERE id_casino='$id'";
		$result=$mysqli->query($query);
		$row=$result->fetch_assoc();
	 ?>
	
	<form action="modificar_casino_final.php?id=<?php echo $row['id_casino']; ?>" method="POST">
		<br><br>
		...
		<input type="text" REQUIERED name="apellido_mat" placeholder="Apellido Mat" value="<?php echo $row['apellido_mat']; ?>" /><br/><br/>
							Cargo: <br>
							 	<input type="radio" name="tipo_casino" value="admin_casino" checked> Admin Casino <br>
  								<input type="radio" name="tipo_casino" value="funcionario"> Funcionario<br> <br>
