  ...
  <table class="table">
    <thead>
        ...
        <?php
          ...
          $query="SELECT * FROM alumno WHERE promocion=$PROMO";
    ...
    ?> 
      <tr>
        ...
        <td><a href="modificar.php?id=<?php echo $fila['id_alumno'] ?>" class="btn btn-warning btn-xs"> Modificar Alumno</td>
        <td><a href="eliminar_final.php?id=<?php echo $fila['id_alumno'] ?>" class="btn btn-danger btn-xs"> Eliminar Alumno</td>
