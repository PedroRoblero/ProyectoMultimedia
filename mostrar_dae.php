  ...
  <table class="table">
    ...
    ?> 
      <tr>
        ...
        <td><a href="modificar_dae.php?id=<?php echo $fila['id_dae'] ?>" class="btn btn-warning btn-xs"> Modificar Funcionario</td>
