...
<body>
	...
	<form action="modificar_alumno_final.php?id=<?php echo $row['id_alumno']; ?>" method="POST" class="form-group">
		<div class="form-group col-md-6">
			<label>Nombre</label> <br>
			<input type="text" REQUIERED name="nombre" placeholder="Nombre" value="<?php echo $row['nombre']; ?>" />
		</div>
		<div class="form-group col-md-6">
			<label>Apellido Paterno</label> <br>
			<input type="text" REQUIERED name="apellido_paterno" placeholder="Apellido Pat" value="<?php echo $row['apellido_paterno']; ?>" />
		</div>
		<div class="form-group col-md-6">
			<label>Apellido Materno</label><br>
			<input type="text" REQUIERED name="apellido_materno" placeholder="Apellido Mat" value="<?php echo $row['apellido_materno']; ?>" />
		</div>
		<div class="form-group col-md-6">
			<label>Carrera</label> <br>
			<input type="text" REQUIERED name="carrera" placeholder="Carrera" value="<?php echo $row['carrera']; ?>" />
		</div>
		<div class="form-group col-md-6">
			<label>Promocion</label><br>
			<input type="text" REQUIERED name="promocion" placeholder="Promocion" value="<?php echo $row['promocion']; ?>" />
		</div>
		<div class="form-group col-md-6">
			<label>Estado</label><br>
			<input type="text" REQUIERED name="estado" placeholder="Estado" value="<?php echo $row['estado']; ?>" />
			<small class="form-text text-muted">1 para alumno activo ; 0 para alumno inactivo.</small>
		</div>
		<div class="form-group col-md-6">
			<label>Correo</label>	<br>
			<input type="text" REQUIERED name="correo" placeholder="Correo" value="<?php echo $row['correo']; ?>" />
		</div>	<br>
