...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="calendario_casino.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Estadisticas Dia Particular</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-md-8">
				...
				<form action="estaditica_dia_particular.php" method="POST">
					<input type="date" name="fecha" required>
					<input type="submit" value="enviar" class="btn btn-info" required>
				</form>
