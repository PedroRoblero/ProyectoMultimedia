<?php 
	...
	if(isset($_SESSION['usuario'])){
		...
		if($_SESSION['usuario']['tipo_usuario'] != "asist_social"){
...
<body>
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
						    <li><a href="cambiar_contraseña_asist_social.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Cambiar Contraseña</a></li> 
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="mostrar_alumnos_becados_asist_social.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Mostrar Alumnos Becados</a></li>
			<li><a href="mostrar_alumnos_no_becados_asist_social.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Mostrar Alumnos No Becados</a></li>
			<li><a href="#"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Estadistica de un Alumno Particular</a></li>
			...
			<div class="col-md-8">
				...
				<div class="container-fluid">
					...
					<?php
						...
						$query = "SELECT pass FROM usuario WHERE user= '".$_SESSION['usuario']['user']."'";
						$result=$mysqli->query($query);
						
						 ?>
	
						<form action="cambiar_contraseña_final.php" method="POST">
						<br> <h2>
						<?php foreach($result as $fila)
						  echo "Su Contraseña Actual es : ".$fila['pass'];
						 ?> </h2>
						 <br> <br>
						<input type="password" REQUIERED name="newpass" placeholder="Contraseña Nueva"  /><br/><br/>
