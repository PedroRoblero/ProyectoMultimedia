...
<body>
        ...
        <ul class="user-menu">
          <li class="dropdown pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="cambiar_contraseña_funcionario.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Cambiar Contraseña</a></li>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li><a href="mostrar_alumnos_becados_funcionario.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Mostrar Alumnos Becados</a></li>
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="container-fluid">
              ...
              <form action="mostrar_alumno_becado_buscar_funcionario.php" method="post">
